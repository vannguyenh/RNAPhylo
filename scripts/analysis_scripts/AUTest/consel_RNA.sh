...
${RAXML} -f G -s ${fasta_file} -m GTRGAMMA -z ${combineTree} -n ${persite_suffix} -w ${persite_path} -S ${ss_file} -A ${model}
...
# --puzzle ~/RF02052/persitelh/RAxML_perSiteLLs.RF02052.raxml_inSS.sitelh 
# ~/RF02052/consel/persite_test
